...
<a class="addnew" href="doctor_use_external.php" style="font-face:Khmer OS Battambang; font-size:16px;">ADD NEW RECORD</a></font>

<br><br>
	<div class="search">
	<form method="post" action="admin_exphy_search.php">
	...
	<table>
        ...
        <?php
			...
			$sql = "select * FROM doctor,externalphysican WHERE doctor.d_id=externalphysican.d_id";
		...
		<tr>
			...
			<td align="center"><a href="doctor_use_external.php? txtid=<?php echo $tr[0];?>">Delete</a> / <a href="doctor_use_external.php? txtid=<?php echo $tr[0];?>">Edit</a> </td>    
		</tr>
