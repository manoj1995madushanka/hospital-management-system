...
<br>
<a class="addnew" href="pat_ward.php" style="font-face:Khmer OS Battambang; font-size:16px;">BACK</a></font>
	<table>
    	<tr>
            <th>WARD NO</th>
            <th>WARD NAME</th>
    ...
    <?php
		...
		if($text==""){
			...
			echo '<a href="pat_ward.php"><img src="images/Users_Group.png" title="Go Back"></a>';
		}
	?>
    <?php
		$cbo = $_POST['cbosearch'];
