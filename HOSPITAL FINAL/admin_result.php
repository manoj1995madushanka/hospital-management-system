...
<br><br>
<center><h1>TEST RESULT TABLE</h1></center>
<br>

<a class="addnew" href="result_use.php" style="font-face:Khmer OS Battambang; font-size:16px;">ADD NEW RECORD</a></font>

<br><br>
	<div class="search">
	<form method="post" action="admin_result_search.php">
	...
	<table>
		...
		<tr>
			...
			<td align="center"><a href="result_use.php? txtid=<?php echo $tr[0];?>">Delete</a> / <a href="result_use.php? txtid=<?php echo $tr[0];?>">Edit</a> </td>    
		</tr>
