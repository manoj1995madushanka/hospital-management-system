...
<br>
<a class="addnew" href="doc_consultant_records.php" style="font-face:Khmer OS Battambang; font-size:16px;">BACK</a></font>
	<table>
    	<tr>
            <th>DoctorID</th>
            <th>FIRST NAME</th>
    ...
    <?php
		...
		if($text==""){
			...
			echo '<a href="doc_consultant_records.php"><img src="images/Users_Group.png" title="Go Back"></a>';
		}
	?>
    <?php
		$cbo = $_POST['cbosearch'];
