...
<br>
<a class="addnew" href="admin_hospitaldoctor.php" style="font-face:Khmer OS Battambang; font-size:16px;">BACK</a></font>
	<table>
    	<tr>
            <th>DoctorID</th>
            <th>FIRST NAME</th>
    ...
    <?php
		...
		if($text==""){
			...
			echo '<a href="admin_hospitaldoctor.php"><img src="images/Users_Group.png" title="Go Back"></a>';
		}
	?>
    <?php
		$cbo = $_POST['cbosearch'];
